...
public class Flame {
    ...
    private void destroyEnemyUI() {
        for (Entity entity : enemyExploded) {
            ...
            else if(entity instanceof Minvo) enemy = new ImageView(Sprite.minvo_dead.getFxImage());
            else if(entity instanceof Kondoria) enemy = new ImageView(Sprite.kondoria_dead.getFxImage());
            else if(entity instanceof Doll) enemy = new ImageView(Sprite.doll_dead.getFxImage());
